...
export const benefits: Benefit[] = [
  ...
  {
    id: "eficaz",
    title: "Eficaz para todos los casos",
    description:
    ...
    testimonial: {
      ...
      name: "Bayron H.",
      quote:
        "Buscaba lugares donde me dijeran que no me tenía que operar a la larga. Aquí pudieron darme la solución que yo esperaba",
      type: "text",
    },
  },
  {
    id: "personalizado",
    title: "Brackets personalizados",
    description:
    ...
    testimonial: {
      id: "maria",
      name: "María C.",
      quote: "A la semana de ponérmelos estaba cantando igual que antes",
      type: "text",
    },
  },
  {
    ...
    testimonial: {
      ...
      name: "Teresita D.",
      quote:
        "En la adolescencia me puse los frenillos tradicionales y no quería lo mismo, pero si necesitaba brackets para arreglar mi mordida",
      type: "text",
    },
  },
];
